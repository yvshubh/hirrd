...
const ApplyJobDrawer = ({user, job, applied=false, fetchJob}) => {
  ...
  return (
    ...
    <DrawerContent>
        ...
        <DrawerDescription className="text-center mt-2">Please fill the form below.</DrawerDescription>
        </DrawerHeader>

        <form onSubmit={handleSubmit(onSubmitHandler)} className='flex flex-col gap-4 p-4 pb-0'>
            <Input 
            type='number'
